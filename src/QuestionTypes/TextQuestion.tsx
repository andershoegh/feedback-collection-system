...
const TextQuestion: React.FC<TextQuestionProps> = (props) => {
    const { currentStep, renderOnStep, question, handleChoice, goBackOneStep } = props;
    ...
    const playAnimation = useCallback(() => {
        const answerReceived = () => {
            ...
            setTimeout(() => setGetAnswerText(language === 'Danish' ? 'Svar modtaget!' : 'Answer received!'), 1300);
        ...
        setGetAnswerText(language === 'Danish' ? 'Venter på et svar fra din telefon' : 'Waiting for an answer from your phone');
        setRedoAnswer(false);
                ...
                <div className='w-4/5 h-screen relative'>
                    ...
                    <div className='absolute top-32'>
                        ...
                        <div className='font-normal text-gray-600 mt-2'>
                            {language === 'Danish' ? 'Indtast dit svar på din telefon' : 'Type your answer on your phone'}
                        </div>
                        <div className='flex flex-col items-center mt-40'>
                            ...
                            {!redoAnswer ? null : (
                                <Touchless
                                    ...
                                    className={'mt-14 px-4 py-1 text-lg place-items-center border-4 border-transparent'}
                                >
                                    {language === 'Danish'
